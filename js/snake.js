        ...
        me.handleDeath = function() {
            function recordScore () {
                ...
                if (me.snakeLength > highScore) {
                    alert('Du slo din egen highscore.. gj ' + highScore + '.');
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "F11 for fullscreen";   
            }
            welcomeTxt.innerHTML = "JavaScript Snake<p></p>Bruk <strong>arrow keys</strong> for aa spille. " + fullScreenText + "<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "JavaScript Snake<p></p>You ded :)<p></p>";
...
function getHighScore () {
    document.getElementById('high-score').addEventListener('click', function () {
        if (localStorage.jsSnakeHighScore == undefined) alert('Du har ikke spilt enda!');
        else
    alert('Din hoyeste highscore er ' + localStorage.jsSnakeHighScore + '.'); });
}
getHighScore();